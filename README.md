...
<h3 align="center">Selenium Jira Automation Test</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/Bogii02/Automation_Testing_3rd-TW"><strong>Explore the docs »</strong></a>
    <br />
    <br />
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone git@github.com:Bogii02/Automation_Testing_3rd-TW.git
   ```
...
Boglarka Bakos - [GitHub](https://github.com/Bogii02) - [LinkedIn](https://www.linkedin.com/in/boglarka-bakos/)
